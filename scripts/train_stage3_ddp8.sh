...
# Stage3: 重度 PMC（更强腐蚀 + 更强一致性约束）
#
# 用法：
#   bash scripts/train_stage3_ddp8.sh <STAGE2_CKPT_DIR> [OUTDIR]
#
# 例子：
#   bash scripts/train_stage3_ddp8.sh checkpoints/stage2_light_pmc_ddp8/checkpoint-2000
#
# 监控：
...
if [[ $# -lt 1 ]]; then
  echo "Usage: $0 <STAGE2_CKPT_DIR> [OUTDIR]"
  exit 1
fi
