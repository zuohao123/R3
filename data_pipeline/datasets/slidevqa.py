"""
SlideVQA dataset adapter for R^3.
"""
...
class SlideVQADataset(BasePMCDataset):
    """
    Expects slidevqa_{split}.json with fields:
    [
      {
        "id": "...",
        "question": "...",
